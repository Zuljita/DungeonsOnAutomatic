...
- main:
  ...
  - tabpanel "Generator":
    ...
    - link "Download SVG":
      - /url: blob:http://localhost:5173/c4626df3-55a6-4d2e-a77e-36f47267b5f4
    ...
    - application "Interactive dungeon map":
      ...
      - img: "1234567891011121314151617181920"
      - text: Overview
      - button "−"
      - img: "1234567891011121314151617181920"
    ...
    - paragraph:
      - strong: "Features:"
      - text: Fountain, Furniture
    - paragraph:
      - strong: "Monsters:"
      - text: Goblin [goblin, humanoid, chaotic]
    - heading "Room 16" [level=3]
    - paragraph:
      - emphasis: chamber
    - paragraph:
      - strong: "Tags:"
    ...
    - paragraph:
      - strong: "Treasure:"
      - text: gems (standard) [gems, precious]
    - heading "Room 18" [level=3]
    - paragraph:
      - emphasis: chamber
    - paragraph:
      - strong: "Tags:"
      - text: rectangular chamber
    - heading "Room 19" [level=3]
    - paragraph:
      - emphasis: chamber
    - paragraph:
      - strong: "Tags:"
    ...
    - paragraph:
      - strong: "Monsters:"
      - text: Orc [orc, humanoid, brutal]
    - paragraph:
      - strong: "Treasure:"
      - text: coins (minor) [coins, mundane]
    - heading "Room 20" [level=3]
    - paragraph:
      - emphasis: chamber
    - paragraph:
      - strong: "Tags:"
    ...
    - paragraph:
      - strong: "Features:"
      - text: Statue
    - text: "{ \"rooms\": 20, \"width\": 80, \"height\": 80, \"layoutType\": \"rectangle\", \"roomLayout\": \"scattered\", \"roomSize\": \"medium\", \"roomShape\": \"rectangular\", \"corridorType\": \"straight\", \"pathfindingAlgorithm\": \"manhattan\", \"corridorWidth\": 1, \"allowDeadends\": true, \"stairsUp\": false, \"stairsDown\": false, \"entranceFromPeriphery\": false, \"system\": \"generic\", \"theme\": \"none\" }"
```