...
/// <summary>
/// Represents a single tile definition with tags and generation properties.
/// This is a pure C# data class, independent of any game engine.
/// </summary>
public class TileData : ITaggable
{
    ...
    /// <summary>
    /// String array for serialization. Use Tags property in code.
